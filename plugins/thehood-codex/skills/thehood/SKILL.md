...
3. If MCP tools are unavailable, check whether the runtime CLI is installed with `thehood --version`.
4. If the runtime is missing, ask before installing or building it.
